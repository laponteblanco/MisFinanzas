...
const PAGES = [
  ...
  },
  {
    ...
    component: (
      <div className="w-full flex justify-center pt-2">
        <div className="w-full max-w-sm h-[320px] relative min-w-0">
          <ExpenseChart />
        </div>
      </div>
    )
  ...
  {
    id: "reminders",
    title: "Próximos Pagos y Recordatorios",
    icon: <Bell size={18} />,
...
export function ModuleBook() {
  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto py-4 perspective-[1500px]" data-tour="module-book">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] border border-white/[0.08] bg-gradient-to-br from-[#0a0f18]/90 via-[#0e1420]/95 to-[#050910]/95 p-6 sm:p-8 shadow-[0_32px_90px_-20px_rgba(0,0,0,0.9)] backdrop-blur-2xl">
        ...
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-white/[0.06] pb-4 mb-6">
        ...
        <div className="relative min-h-[350px] w-full flex flex-col justify-between overflow-hidden">
